                ...
                <tr>
                                ...
                                <td>
                                    <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="width:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p align="left" style="max-width:100%;font-size:16px;line-height:18px;font-family: Arial, Helvetica, sans-serif; margin-bottom:0; margin-top:0; margin-left:0; margin-right:0; padding-bottom:0; padding-top:0; padding-left:0; padding-right:0; color:#8a8a8a;">User</p>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p align="left" style="max-width:100%;font-size:24px;line-height:18px;font-family: Arial, Helvetica, sans-serif; margin-bottom:0; margin-top:0; margin-left:0; margin-right:0; padding-bottom:0; padding-top:0; padding-left:0; padding-right:0; color:#4a4a4a; font-weight:bold;">
                                                    <a href="{{ url('/admin/client/'.$user_id) }}">{{ $user_id }}</a>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="width:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:6px"></td>
                                            <td>
                                                <p align="left" style="max-width:100%;font-size:16px;line-height:18px;font-family: Arial, Helvetica, sans-serif; margin-bottom:0; margin-top:0; margin-left:0; margin-right:0; padding-bottom:0; padding-top:0; padding-left:0; padding-right:0; color:#8a8a8a;">Price</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" style="height:9px;"></td>
                                    ...
                                    <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="width:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:6px"></td>
                                            <td>
                                                <p align="left" style="max-width:100%;font-size:16px;line-height:18px;font-family: Arial, Helvetica, sans-serif; margin-bottom:0; margin-top:0; margin-left:0; margin-right:0; padding-bottom:0; padding-top:0; padding-left:0; padding-right:0; color:#8a8a8a;">Find out Prices and conditions</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" style="height:9px;"></td>
                                    ...
                                    <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="width:100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:6px"></td>
                                            <td>
                                                <p align="left" style="max-width:100%;font-size:16px;line-height:18px;font-family: Arial, Helvetica, sans-serif; margin-bottom:0; margin-top:0; margin-left:0; margin-right:0; padding-bottom:0; padding-top:0; padding-left:0; padding-right:0; color:#8a8a8a;">How many sources to find?</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" style="height:9px;"></td>
                    ...
                    <td style="vertical-align: top;">
                        ...
                        <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="width:100%;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <p align="left" style="max-width:100%;font-size:34px;line-height:18px;font-family: Arial, Helvetica, sans-serif; margin-bottom:0; margin-top:0; margin-left:0; margin-right:0; padding-bottom:0; padding-top:0; padding-left:0; padding-right:0; color:#4a4a4a;">Price</p>
                                </td>
                            </tr>
                            <tr>
